        ...
        <div className="space-y-[var(--space-400)]">
          ...
          <section className="rounded-2xl border border-[var(--color-border-soft)] bg-[var(--color-surface-muted)] p-[var(--space-400)]">
            ...
            <dl className="mt-3 grid grid-cols-3 gap-4 text-xs text-[var(--color-text-muted)]">
              <div>
                <dt className="tracking-wide uppercase">Min</dt>
                <dd
                  className={`mt-1 font-medium ${validation?.min ? "text-red-500" : "text-[var(--color-text-primary)]"}`}
                >
              ...
              <div>
                <dt className="tracking-wide uppercase">Mode</dt>
                <dd
                  className={`mt-1 font-medium ${validation?.mode ? "text-red-500" : "text-[var(--color-text-primary)]"}`}
                >
              ...
              <div>
                <dt className="tracking-wide uppercase">Max</dt>
                <dd
                  className={`mt-1 font-medium ${validation?.max ? "text-red-500" : "text-[var(--color-text-primary)]"}`}
                >
